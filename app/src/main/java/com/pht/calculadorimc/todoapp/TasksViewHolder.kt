...
class TasksViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun render(task: Task) {
        ...
        if (task.isSelected) {
            tvTask.paintFlags =
                tvTask.paintFlags or Paint.STRIKE_THRU_TEXT_FLAG //Sirve para marcar una tarea realizada
        } else {
            tvTask.paintFlags =
                tvTask.paintFlags and Paint.STRIKE_THRU_TEXT_FLAG.inv() //Sirve para desmarcar una tarea realizada
        }
